...
urlpatterns = [
    ...
    path("edit_session/<int:session_id>",hod_views.edit_session, name='edit_session'),
    ...
    path("view_student_leave", hod_views.view_student_leave,name="view_student_leave",),
    ...
    path("get_admin_attendance", hod_views.get_admin_attendance,name='get_admin_attendance'),
    ...
    path("edit_student/<int:student_id>",hod_views.edit_student, name='edit_student'),
    path("edit_course/<int:course_id>",hod_views.edit_course, name='edit_course'),
    path("edit_subject/<int:subject_id>",hod_views.edit_subject, name='edit_subject'),
    ...
    path("edit_student_result", EditResultView.as_view(),name='edit_student_result'),
